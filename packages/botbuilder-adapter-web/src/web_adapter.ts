 ...
 * To use this adapter, you will need a compatible chat client — [use the one included in the project repo here](https://github.com/howdyai/botkit/tree/master/packages/botbuilder-adapter-web/client).
 */
